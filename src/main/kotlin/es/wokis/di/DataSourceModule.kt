...
import es.wokis.data.datasource.local.sensor.SensorLocalDataSourceImpl
...
val localDataSourceModule = module {
    ...
    single(named("sensorsCollection")) { getSensorsCollection(get()) }
    ...
    single<SensorLocalDataSource> { SensorLocalDataSourceImpl(get(named("sensorsCollection"))) }
}
...
private fun getSensorsCollection(database: AppDataBase) = database.sensorsCollection
