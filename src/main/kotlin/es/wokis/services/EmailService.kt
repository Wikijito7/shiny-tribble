...
class EmailService(
    ...
    companion object {
        private const val VERIFY_EMAIL_EN = "Base Ktor Server - Verify Email"
        private const val VERIFY_EMAIL_ES = "Base Ktor Server - Verificar Email"
        private const val RECOVER_PASS_EN = "Base Ktor Server - Recover password"
        private const val RECOVER_PASS_ES = "Base Ktor Server - Recuperar contraseña"
    }
}
