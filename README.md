# shiny-tribble
shiny-tribble is a server used to save and get info from ESP32 clients that uses this server as their backup.

## Index
* [Pre-requisites](https://github.com/Wikijito7/shiny-tribblet#pre-requisites)
* [How to run it](https://github.com/Wikijito7/shiny-tribble#how-to-run-it)
* [How it works](https://github.com/Wikijito7/shiny-tribble#how-it-works)
* [TODO](https://github.com/Wikijito7/shiny-tribble#todo)

## Pre-requisites
* Java 17.
* Other requisites are already built in on `build.gradle.kts`. ([See more here](https://github.com/Wikijito7/shiny-tribble/blob/master/build.gradle.kts))
...
- Also, you can generate a `fat-jar` by executing `fatJar` task on `build.gradle.kts`. After that, you may execute the app by double clicking it or by executing it on a terminal using `java -jar shiny-tribble.jar`.
...
## TODO:
Any suggestion? Create a ticket [here](https://github.com/Wikijito7/shiny-tribble/issues).

## Known bugs
* Have you found one? Create a ticket [here](https://github.com/Wikijito7/shiny-tribble/issues).
